...
This script searches for Agentic AI related content, summarizes it, and sends a daily email digest.
"""
...
def send_email(email_content: str):
    ...
    email_params = {
        "subject": "Agentic AI Research Summary",
        "sender": {"name": "Amal Thomas", "email": os.getenv("DESTINATION_EMAIL")},
        "html_content": email_content,
        "to": [{"email": os.getenv("DESTINATION_EMAIL"), "name": "Amal Thomas"}],
        "params": {"subject": "Agentic AI Research Summary"}
    }
